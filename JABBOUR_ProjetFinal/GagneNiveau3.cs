...
namespace JABBOUR_ProjetFinal
{
    ...
    public partial class GagneNiveau3 : Form
    {
        // Musique d'arrire plan
        SoundPlayer sound = new SoundPlayer(Properties.Resources._03___How_High_Can_You_Get);
        ...
        // Commence le quatrieme et dernier niveau
        private void prochainNiveau_Tick(object sender, EventArgs e)
        {
            this.Hide();
            QuatriemeNiveau quatriemeNiveau = new QuatriemeNiveau();
            quatriemeNiveau.Closed += (s, args) => this.Close();
            quatriemeNiveau.Show();
            prochainNiveau.Stop();
        }
    }
}
